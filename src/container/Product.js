    ...
    <div className='card m-2'>
      ...
      <div className='mt-2'>
        <img
          ...
          width={400}
          alt={props.title}
          className='border-radius img-fluid'
        />
      </div>
      <div className='mt-3 card-body'>
        <h5 className='card-title'>{props.title}</h5>
        ...
        <div className='mt-4'>
          {props.stock > 0 ? (
            <>
              <button
                className='btn btn-primary btn-outline-warning'
              ...
              {element?.count > 0 ? (
                ...
                <button className='ms-4 btn btn-primary btn-outline-warning' onClick={addToCart}>
                  Add To Cart
                </button>
              )}
            </>
